...
export declare const createGeomData: (map: Map, entities?: any, docMapBounds?: any, environment?: any, linetypes?: any, dbFrom?: any, asFeatureCollection?: boolean, renderAccuracy?: number) => Promise<{
    type: string;
    features: {
        id: any;
        type: string;
