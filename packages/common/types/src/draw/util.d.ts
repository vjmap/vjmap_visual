...
export declare const drawEllipseFill: (map: Map, draw: IDrawTool, options?: Record<string, any>, drawProperty?: Record<string, any>, showInfoFunc?: Function) => Promise<any>;
export declare const drawEllipseEdge: (map: Map, draw: IDrawTool, options?: Record<string, any>, drawProperty?: Record<string, any>, showInfoFunc?: Function) => Promise<any>;
export declare const drawEllipseFillArc: (map: Map, draw: IDrawTool, options?: Record<string, any>, drawProperty?: Record<string, any>, showInfoFunc?: Function) => Promise<any>;
export declare const drawEllipseArc: (map: Map, draw: IDrawTool, options?: Record<string, any>, drawProperty?: Record<string, any>, showInfoFunc?: Function) => Promise<any>;
...
export declare const drawArrow: (map: Map, draw: IDrawTool, options?: Record<string, any>, drawProperty?: Record<string, any>, showInfoFunc?: Function, param?: Record<string, any>) => Promise<any>;
...
export declare const drawText: (map: Map, draw: IDrawTool, options?: Record<string, any>, drawProperty?: Record<string, any>, showInfoFunc?: Function, disableInteractive?: boolean, docBounds?: [number, number, number, number]) => Promise<any>;
